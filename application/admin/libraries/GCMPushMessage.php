...
class GCMPushMessage {
    ...
    */
    function GCMPushMessage(){
        $this->serverApiKey = "AIzaSyB-HqvxuMpIdU7A_077yYd2XlhxL5KhB0U";
    }
    /*
    ...
    */
    function send($message, $data = false){
        ...
        $fields = array(
            ...
            //'notification'      => array( "text" => $message ),
        ...
        echo '<pre>'.json_encode( $fields, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP ).'</pre>';
