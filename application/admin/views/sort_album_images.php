		...
		<div id="contentLeft2">
			<ul>
				...
				//{
                                ...
                                {
				?>
                            <li id="recordsArray_<?php echo $wi['img_id']; ?>">
                                <div>
                                    <table cellpadding="2">
                                        <tr>
                                    ...
                                    <td>
                                      <img src="<?php echo base_url();?>album/images/<?php echo $wi['album_image']; ?>" width="120" height="120"> 
                                    </td>
...
$(document).ready(function(){ 
    ...
    $(function() {
        $("#contentLeft2 ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
            ...
            $.post("<?php echo base_url();?>admin.php/dashboard/order_album_images", order, function(theResponse){
