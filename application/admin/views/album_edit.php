...
<form name="album" id="album" action="<?php echo base_url();?>admin.php/edit/album_submit" method="post" enctype="multipart/form-data" onsubmit="return validate_album()">
  <input type="hidden" name="category" value="<?php echo $category[0]['aid'];?>">
    ...
    <tr>
        <td>Uploaded cover Iamge</td>
         <td class="center">
                   ...
                   <img src="<?php echo base_url();?>album/<?php echo $category[0]['cover_image'];?>" width="130" height="130">
