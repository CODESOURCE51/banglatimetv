...
<form name="news" id="news" action="<?php echo base_url();?>admin.php/dashboard/multi_news_delete" method="post" enctype="multipart/form-data">
<input type="hidden" name="category" id="category" value="" />
  <div class="row" id="about_contant" style="display:block;">
    ...
    <?php  foreach($post_list as $wi)
				...
				?>
    <tr>
        <td><input type="checkbox" id="mnews"  name="mnews" value="<?php echo $wi['news_id']; ?>"/></td>
        <td class="center">
       <?php echo $wi['name']; ?> 
...
for (var i=0; i<checkboxes.length; i++) {
 ...
 if(selected == '') {
    ...
    window.open('<?php echo base_url();?>admin.php/Dashboard/multi_news_delete/'+btoa(encodeURIComponent(selected)),'_self');
 }
}
</script>
