...
<form name="news" id="news" action="<?php echo base_url();?>admin.php/dashboard/multi_videos_delete" method="post" enctype="multipart/form-data">
<input type="hidden" name="category" id="category" value="" />
  <div class="row" id="about_contant" style="display:block;">
    <div class="box col-md-12">
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
         <h2><i class="glyphicon glyphicon-edit"></i> Delete Multiple News</h2>
    ...
    <?php  foreach($post_list as $wi)
				...
				?>
    <tr>
        <td><input type="checkbox" id="mnews"  name="mnews" value="<?php echo $wi['vid']; ?>"/></td>
        <td class="center">
        
       <iframe width="300" height="160" src="https://www.youtube.com/embed/<?php echo $wi['video'];?>" frameborder="0" allowfullscreen></iframe>   
                </td>
...
for (var i=0; i<checkboxes.length; i++) {
 ...
 if(selected == '') {
    ...
    window.open('<?php echo base_url();?>admin.php/Dashboard/multi_videos_delete/'+btoa(encodeURIComponent(selected)),'_self');
 }
}
</script>
