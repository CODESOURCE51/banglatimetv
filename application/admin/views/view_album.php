...
<div>
 ...
 <div class="row" id="about_contant" style="display:block;">
    ...
    <div class="box-header well" data-original-title="">
         <h2><i class="glyphicon glyphicon-edit"></i> Showing Albums</h2>
    ...
    <tr>
        ...
        <td class="center">
                   ...
                   <img src="<?php echo base_url();?>album/<?php echo $value['cover_image'] ;?>" height="130" width="130"/>
        ...
        <td class="center">
            ...
            <a class="btn btn-info" href="<?php echo base_url();?>admin.php/Edit/album/<?php echo $value['aid'] ;?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a class="btn btn-danger" href="<?php echo base_url();?>admin.php/Delete/album/<?php echo $value['aid'] ;?>" onclick="return Confirm('Are you sure you want to delete this Category')">
