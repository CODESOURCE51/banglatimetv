...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Album Video</a>
        </li>
    </ul>
</div>

<form name="video" id="video" action="<?php echo base_url();?>admin.php/Edit/add_album_videos" method="post" enctype="multipart/form-data" onsubmit="return validate_video()">
<input type="hidden" name="category" value="<?php echo $category[0]['vid'];?>">
  <div class="row" id="about_contant" style="display:block;">
    <div class="box col-md-12">
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
         <h2><i class="glyphicon glyphicon-edit"></i> Add Album Video</h2>
