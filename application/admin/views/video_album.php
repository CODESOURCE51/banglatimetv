...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="#">Create Video Album</a>
        </li>
    </ul>
</div>

<form name="album" id="album" action="<?php echo base_url();?>admin.php/dashboard/add_video_album" method="post" enctype="multipart/form-data" onsubmit="return validate_album()">
  <div class="row" id="about_contant" style="display:block;">
    <div class="box col-md-12">
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
         <h2><i class="glyphicon glyphicon-edit"></i> Add Video Album</h2>
    ...
    <tr>
        <td></td>
        <td class="center"><a href="<?php echo base_url();?>admin.php/dashboard/view_video_album" class="btn btn-warning">View Video Album</a></td>
