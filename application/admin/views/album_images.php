...
<form name="news" id="news" action="<?php echo base_url();?>admin.php/dashboard/add_album_snaps" method="post" enctype="multipart/form-data" onsubmit="return validate_albam_snap()">
<input type="hidden" name="category" id="category" value="" />
  <div class="row" id="about_contant" style="display:block;">
    ...
    <tr>
        <td></td>
        <td class="center"><a href="<?php echo base_url();?>admin.php/dashboard/view_album_snaps" class="btn btn-warning">View Album Images</a></td>
