			...
			*/
			...
			{	
				...
				if ($page > 1) 
					...
					$pagination.= "<a href=\"$targetpage/$prev\"><< পূর্ববর্তী গ্যালারি</a>";

				else

					$pagination.= "<a href=\"javascript:void(0)\"><< পূর্ববর্তী গ্যালারি</a>";	
...

					{
...

						{
							...
							if ($counter == $page)
								...
								$pagination.= "<a href=\"javascript:void(0)\"><span>$counter</span></a>";
				...
				if ($page < $counter - 1) 
					...
					$pagination.= "<a href=\"$targetpage/$next\">পরবর্তী গ্যালারি >></a>";

				else

					$pagination.= "<a href=\"javascript:void(0)\">পরবর্তী গ্যালারি >></a>";
