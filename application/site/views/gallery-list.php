...
<div class="content row">
    ...
    <div class="ambrogrid_10">
        <div class="widget-lbg">
            <div class="widget-title">গ্যালারি সূচী</div>
        </div>
        <?php if (!empty($service_data)) { foreach($service_data as $s_data) { ?>
        <a href="<?php echo base_url();?>index.php/gallery/galleryImages/<?php echo $s_data['aid'];?>" class="gallery-tile">
            <img src="<?php echo base_url();?>album/<?php echo $s_data['cover_image'];?>" alt="">
